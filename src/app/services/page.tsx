  ...
  return (
    <div className="
     px-4 py-12 md:px-6 md:py-16 lg:py-20">
      <div className="mb-10">
        <h1 className="font-serif text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Our Services</h1>
        <p className="mt-4 max-w-3xl text-muted-foreground">
          From custom furniture to complete home renovations, we offer a wide range of woodworking services tailored to
        ...
        <Tabs defaultValue="furniture" className="w-full">
          ...
          <TabsContent value="furniture" className="space-y-8">
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                <h2 className="mb-4 font-serif text-3xl font-bold">Custom Furniture</h2>
                <p className="mb-4 text-muted-foreground">
                  Our custom furniture is designed and built specifically for you, taking into account your space, style
                  preferences, and functional needs. Each piece is handcrafted using traditional woodworking techniques
                  combined with modern precision.
                </p>
                <p className="mb-6 text-muted-foreground">
                  We work with a wide range of domestic and exotic hardwoods, and can incorporate other materials such
                  as metal, glass, and stone to create truly unique pieces that will become family heirlooms.
                </p>
          ...
          <TabsContent value="renovations" className="space-y-8">
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                <h2 className="mb-4 font-serif text-3xl font-bold">Home Renovations</h2>
                <p className="mb-4 text-muted-foreground">
                  Transform your living spaces with our custom woodworking and cabinetry services. We specialize in
                  kitchen and bathroom renovations, built-in shelving, custom trim work, and more.
                </p>
                <p className="mb-6 text-muted-foreground">
                  Our renovation services include design consultation, material selection, custom fabrication, and
                  professional installation. We work closely with homeowners, interior designers, and contractors to
          ...
          <TabsContent value="outdoor" className="space-y-8">
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                <h2 className="mb-4 font-serif text-3xl font-bold">Outdoor Structures</h2>
                <p className="mb-4 text-muted-foreground">
                  Extend your living space to the outdoors with our custom-designed and built structures. We use
                  weather-resistant woods and finishes to ensure durability and longevity in outdoor environments.
                </p>
                <p className="mb-6 text-muted-foreground">
                  From simple garden benches to elaborate outdoor kitchens, we can help you create the perfect outdoor
                  living space for entertaining, relaxing, and enjoying nature.
                </p>
                <ul className="mb-6 space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-amber-600" />
          ...
          <TabsContent value="commercial" className="space-y-8">
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                <h2 className="mb-4 font-serif text-3xl font-bold">Commercial Projects</h2>
                <p className="mb-4 text-muted-foreground">
                  We work with businesses, restaurants, hotels, and offices to create custom woodwork that enhances
                  their brand and customer experience. Our commercial projects are designed to withstand heavy use while
                  maintaining their beauty.
                </p>
                <p className="mb-6 text-muted-foreground">
                  From reception desks and conference tables to restaurant furnishings and retail displays, we can help
                  you create a distinctive environment that reflects your business identity.
                </p>
                <ul className="mb-6 space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-amber-600" />
      ...
      <section className="mb-16">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            From initial concept to final installation, we guide you through every step
          </p>
        </div>
        <ServiceProcessSteps />
      </section>
      ...
      <section className="mb-16">
        <div className="mb-8">
          <h2 className="font-serif text-3xl font-bold">Materials We Work With</h2>
          <p className="mt-2 text-muted-foreground">
            We source the finest materials to ensure quality, durability, and beauty
          </p>
        </div>
      ...
      <section className="mb-16">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            We proudly serve the following areas with our custom woodworking services
          </p>
        </div>
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div>
            <Card>
              <CardContent className="p-6">
                <h3 className="mb-4 font-serif text-xl font-semibold">Primary Service Areas</h3>
                <ul className="mb-6 space-y-2">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-amber-600" />
                    <span>Craftsville and surrounding areas (30-mile radius)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-amber-600" />
                ...
                <p className="mb-4 text-muted-foreground">
                  For projects outside our primary service area, additional travel fees may apply. For larger projects,
                  we&apos;re willing to travel nationwide.
                </p>
                <p className="text-muted-foreground">
                  Not sure if you&apos;re within our service area? Contact us to discuss your project and location.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="mb-16">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            We provide transparent pricing based on your specific project requirements
          </p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Starting prices for custom pieces</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Estimated ranges for renovation projects</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-4">
                <li className="flex items-center justify-between">
                ...
                <li className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">$300 - $600 per linear ft</span>
                </li>
                <li className="flex items-center justify-between">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Price ranges for outdoor structures</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-4">
                <li className="flex items-center justify-between">
        ...
        <div className="mt-8 text-center">
          <p className="mb-6 text-muted-foreground">
            These prices are estimates and may vary based on materials, complexity, and specific requirements. Contact
      ...
      <section className="mb-16">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">Common questions about our services and process</p>
        </div>
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardContent className="p-6">
              <h3 className="mb-2 font-serif text-lg font-semibold">How long does a custom furniture project take?</h3>
              <p className="text-muted-foreground">
                Depending on the complexity and our current workload, most custom furniture pieces take 6-12 weeks from
                design approval to completion. Larger projects may take longer.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              <h3 className="mb-2 font-serif text-lg font-semibold">Do you provide design services?</h3>
              <p className="text-muted-foreground">
                Yes, we offer comprehensive design services for all our projects. We can work from your ideas, sketches,
                or inspiration photos to create detailed designs and 3D renderings.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              <h3 className="mb-2 font-serif text-lg font-semibold">What is your payment structure?</h3>
              <p className="text-muted-foreground">
                We typically require a 50% deposit to begin work, with the remaining balance due upon completion. For
                larger projects, we may establish a payment schedule with multiple installments.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              <h3 className="mb-2 font-serif text-lg font-semibold">Do you offer warranties on your work?</h3>
              <p className="text-muted-foreground">
                Yes, all our custom pieces come with a 5-year warranty against defects in materials and workmanship. We
                stand behind the quality of our work and are committed to your satisfaction.
              </p>
            </CardContent>
          </Card>
        </div>
        <div className="mt-8 text-center">
          <Button asChild variant="outline" className="border-amber-700 text-amber-700 hover:bg-amber-700/10">
      ...
      <section className="rounded-lg bg-amber-100 p-8 md:p-12">
        <div className="flex flex-col items-center text-center">
          <h2 className="font-serif text-3xl font-bold tracking-tight sm:text-4xl">Ready to Transform Your Space?</h2>
